...
Theme: matches the profile banner (terminal navy #0D1117, green #00FF88,
cyan #00D4FF, violet #BC13FE, mono font, dotted leaders, pulsing dots).

Adapted from arifhaxn/arifhaxn's projects-panel generator.
"""
...
THEMES = {
    "dark": {
        ...
        "CYAN": "#00D4FF", "VIOLET": "#BC13FE", "VIOLET2": "#BC13FE",
        "EMERALD": "#00FF88", "TEXT": "#E6EDF3", "MUTED": "#8B949E",
        "DIM": "#495566",
        "STROKE": "rgba(0,212,255,0.28)", "STROKE_HI": "rgba(0,212,255,0.5)",
        "STROKE_LO": "rgba(0,212,255,0.22)", "BARLINE": "rgba(255,255,255,0.08)",
        "RING_BG": "rgba(139,148,158,0.15)", "PILL_BG": "rgba(188,19,254,0.28)",
        "PILL_STROKE": "rgba(188,19,254,0.5)", "MONO_TX": "#F5F3FF",
    },
    "light": {
        "BG": "#FFFFFF", "PANEL": "#FFFFFF", "PANEL_BAR": "#F6F8FA",
        "CYAN": "#1F6FEB", "VIOLET": "#8250DF", "VIOLET2": "#8250DF",
        "EMERALD": "#1A7F37", "TEXT": "#24292F", "MUTED": "#57606A",
        "DIM": "#94A3B8",
        "STROKE": "rgba(31,111,235,0.30)", "STROKE_HI": "rgba(31,111,235,0.55)",
        "STROKE_LO": "rgba(31,111,235,0.20)", "BARLINE": "rgba(0,0,0,0.08)",
        "RING_BG": "rgba(100,116,139,0.20)", "PILL_BG": "rgba(130,80,223,0.12)",
        "PILL_STROKE": "rgba(130,80,223,0.4)", "MONO_TX": "#FFFFFF",
    },
}
